                    ...
                    <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                        <div class="foto-profil-index">
                            @if (auth()->user()->pelanggan->foto)
                                <img src="{{ asset('storage/' . auth()->user()->pelanggan->foto) }}" class="img-fluid"
                                    alt="">
                            @else
                        ...
                        <h2>{{ auth()->user()->pelanggan->nama }}</h2>
                    </div>
                </div>
            </div>
                        ...
                        <div class="tab-content pt-2">
                            ...
                            <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-md-8">{{ auth()->user()->pelanggan->nama }}</div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-md-8">{{ auth()->user()->pelanggan->no_telp }}</div>
                                </div>

                                <div class="row">
                                    <div class="col-lg-3 col-md-4 label">Jenis Kelamin</div>
                                    <div class="col-lg-9 col-md-8">{{ auth()->user()->pelanggan->jenis_k }}</div>
                                </div>

                                <div class="row">
                                    <div class="col-lg-3 col-md-4 label">Alamat</div>
                                    <div class="col-lg-9 col-md-8">{{ auth()->user()->pelanggan->alamat }}</div>
                                </div>
                            </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <select id="inputJenisKelamin" name="jenis_k"
                                                ...
                                                <option value="L"
                                                    {{ auth()->user()->pelanggan->jenis_k == 'L' ? 'selected' : '' }}>Laki
                                                    Laki
                                                </option>
                                                <option value="P"
                                                    {{ auth()->user()->pelanggan->jenis_k == 'P' ? 'selected' : '' }}>
                                                    Perempuan
                                                </option>
                                            </select>
                                            @error('jenis_k')
