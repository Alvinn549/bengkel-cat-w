...
@section('content')
    <div class="pagetitle">
        <h1>Antrian Perbaikan</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
                <li class="breadcrumb-item active">Antrian Perbaikan</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section dashboard">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Data Antrian Perbaikan</h5>
        ...
        function confirmProses(perbaikanId) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = "{{ route('dashboard.pekerja.proses-perbaikan-antrian', '') }}" + '/' +
                        perbaikanId;
                }
            });
        }
