...
@section('content')
    <div class="pagetitle">
        <h1>Perbaikan Baru</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
                <li class="breadcrumb-item active">Perbaikan Baru</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section dashboard">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Data Perbaikan Baru</h5>
    ...
    <script>
        ...
        function confirmProses(perbaikanId) {
            Swal.fire({
                ...
                text: 'Perbaikan ini akan diupdate statusnya menjadi Antrian',
                icon: 'warning',
