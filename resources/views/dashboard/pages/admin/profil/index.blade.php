                    ...
                    <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                        <div class="foto-profil-index">
                            @if (auth()->user()->admin->foto)
                                <img src="{{ asset('storage/' . auth()->user()->admin->foto) }}" class="img-fluid"
                                    alt="">
                            @else
                        ...
                        <div class="tab-content pt-2">
                            ...
                            <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-md-8">{{ auth()->user()->admin->nama }}</div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-md-8">{{ auth()->user()->admin->no_telp }}</div>
                                </div>

                                <div class="row">
                                    <div class="col-lg-3 col-md-4 label">Jenis Kelamin</div>
                                    <div class="col-lg-9 col-md-8">{{ auth()->user()->admin->jenis_k }}</div>
                                </div>

                                <div class="row">
                                    <div class="col-lg-3 col-md-4 label">Alamat</div>
                                    <div class="col-lg-9 col-md-8">{{ auth()->user()->admin->alamat }}</div>
                                </div>
                            </div>
                            ...
                            <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                                <form class="" action="{{ route('profil.update', auth()->user()->id) }}"
                                    ...
                                    <div class="row mb-3">
                                        <label for="inputNama" class="col-md-4 col-lg-3 col-form-label">Nama<span
                                    ...
                                    <div class="row mb-3">
                                        <label for="inputEmail" class="col-md-4 col-lg-3 col-form-label">Email<span
                                                class="text-danger">*</span></label>
                                        <div class="col-md-8 col-lg-9">
                                    ...
                                    <div class="row mb-3">
                                        <label for="inputPassword" class="col-md-4 col-lg-3 col-form-label">Password<span
                                                class="text-danger">*</span></label>
                                        <div class="col-md-8 col-lg-9">
                                            <input type="password"
                                    ...
                                    <div class="row mb-3">
                                        <label for="inpuNoTelp" class="col-md-4 col-lg-3 col-form-label">No Telp<span
                                                class="text-danger">*</span></label>
                                        <div class="col-md-8 col-lg-9">
                                            <input type="text"
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <select id="inputJenisKelamin" name="jenis_k"
                                                ...
                                                <option value="L"
                                                    {{ auth()->user()->admin->jenis_k == 'L' ? 'selected' : '' }}>Laki
                                                    Laki
                                                </option>
                                                <option value="P"
                                                    {{ auth()->user()->admin->jenis_k == 'P' ? 'selected' : '' }}>
                                                    Perempuan
                                                </option>
                                            </select>
                                            @error('jenis_k')
                                    ...
                                    <div class="row mb-3">
                                        <label for="inputAlamat" class="col-md-4 col-lg-3 col-form-label">Alamat<span
                                                class="text-danger">*</span></label>
                                        <div class="col-md-8 col-lg-9">
                                            <textarea class="form-control @error('alamat') is-invalid @enderror" placeholder="Alamat" name="alamat"
                                                id="inputAlamat" style="height: 100px;">{{ old('alamat') ?? auth()->user()->admin->alamat }}</textarea>
                                            @error('alamat')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
