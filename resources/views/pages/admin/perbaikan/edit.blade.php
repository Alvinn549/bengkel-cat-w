                        ...
                        <div class="row g-3">
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control @error('biaya') is-invalid @enderror"
                                    name="biaya" id="inputBiaya" value="{{ old('biaya') ?? $perbaikan->biaya }}"
                                    pattern="\d+" oninput="this.value = formatNumberInput(this.value)" inputmode="numeric">
                                @error('biaya')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control @error('durasi') is-invalid @enderror"
                                    name="durasi" id="inputDurasi" value="{{ old('durasi') ?? $perbaikan->durasi }}">
                                @error('durasi')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-12">
                                <label for="inputTglSelesai" class="form-label">Tanggal Selesai</label>
                                <input type="date" class="form-control @error('tgl_selesai') is-invalid @enderror"
                                    name="tgl_selesai" id="inputTglSelesai"
                                    value="{{ old('tgl_selesai') ?? date('Y-m-d', strtotime($perbaikan->tgl_selesai)) }}">
                                @error('tgl_selesai')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
