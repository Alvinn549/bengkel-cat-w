...
@section('content')
    ...
    <section class="section">
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="row g-3" action="{{ route('pelanggan.update', $pelanggan) }}" method="POST"
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control @error('nama') is-invalid @enderror"
                                    name="nama" id="inputNama" value="{{ old('nama') ?? $pelanggan->nama }}">
                                @error('nama')
                            ...
                            <div class="col-md-12 mt-3">
                                ...
                                <input type="email" class="form-control @error('email') is-invalid @enderror"
                                    name="email" id="inputEmail" value="{{ old('email') ?? $pelanggan->user->email }}">
                                @error('email')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control @error('alamat') is-invalid @enderror" placeholder="Alamat" name="alamat"
                                    id="inputAlamat" style="height: 100px;">{{ old('alamat') ?? $pelanggan->alamat }}</textarea>
                                @error('alamat')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
        ...
        <div class="text-center">
            ...
            <a href="{{ route('pelanggan.index') }}" class="btn btn-secondary">Kembali</a></a>
        </div>
    </section>
@endsection
